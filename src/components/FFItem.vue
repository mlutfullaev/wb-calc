...
<template>
  <div class="item">
    <h2 class="item-title">Фулфилмент</h2>
    <div class="content">
      <div class="form-item">
        ...
        <input type="text" _ngcontent-serverapp-c127 v-model="ff.logisticsFrom">
      </div>
      <div class="form-item">
        <div class="form-label required">
          <p>Упаковка, ₽</p>
        ...
        <input _ngcontent-serverapp-c127 type="text" placeholder="Стоимость упаковки за 1 ед." v-model="ff.packaging">
      </div>
      <div class="form-item">
        <div class="form-label required">
          <p>Логистика до маркетплейса, ₽</p>
          <HintUI hint="Стоимость логистики за 1 единицу товара" />
        </div>
        <input type="text" _ngcontent-serverapp-c127 v-model="ff.logisticsTo">
      </div>
      <div class="form-item">
        <div class="form-label required">
          <p>Услуги фулфилмента, ₽</p>
          <HintUI hint="Стоимость упаковки, хранения и прочих услуг фулфилмента" />
        </div>
        <input type="text" _ngcontent-serverapp-c127 v-model="ff.services">
      </div>
    </div>
  </div>
</template>
